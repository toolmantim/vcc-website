...
function print_record($record) {
	...
	$pubdate = str_ireplace("+", "", $pubdate);
	$pubdate = str_ireplace(":", "", $pubdate);
	echo "<link>http://new.vicclimb.org.au/events/".$record['post_name']."#".$pubdate."</link>\n";
	echo "<guid>http://new.vicclimb.org.au/events/".$record['post_name']."#".$pubdate."</guid>\n";
	echo "</item>\n";
	echo "\n";
}
...
echo "<link>http://www.vicclimb.org.au/location/events</link>\n";
echo "<atom:link href=\"http://new.vicclimb.org.au/events_rss.php\" rel=\"self\" type=\"application/rss+xml\" />\n";
